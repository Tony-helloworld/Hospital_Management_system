    ...
    <div class="row">
        ...
        <div class="col-sm-6">
            ...
            <div class="card bg-light border-primary mb-3" >
                <div class="card-header"><h4>Register your account</h4></div>
                <div class="card-body">
                    <p class="card-text">

                    <form name="editLogin" action="newRegister.html" method="post" autocomplete="off">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="exampleInputEmail1" name="username" placeholder="Enter Your Username"
                        ...
                        <div class="form-group">
                            ...
                            <input type="password" class="form-control" id="exampleInputEmail1" name="passwordAgain" placeholder="Enter Your Password Again"
                                   required="required" minlength="8" maxlength="8">
                        </div>

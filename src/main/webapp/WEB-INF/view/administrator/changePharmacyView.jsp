    ...
    <div class="row">
        ...
        <div class="col-sm-12">
            ...
            <div class="main"><br/><br/>
                <h1>Edit Drug Details</h1><br/>

                <form action="submitPharmacy.html" method="post" >
                    <%-- 	fields with disabled attribute are not submitted but readonly r submitted --%>
                        <div class="form-group">
                            <label>Name</label>
                            <input type="text" class="form-control" id="exampleInputEmail1" name="Name" value="${ pharmacy.name }" readonly="readonly">
                        </div>

                        <div class="form-group">
                        <label>Used</label>
                        <input type="text" class="form-control" id="Having" name="Having" value="${ pharmacy.drugNumber }"
